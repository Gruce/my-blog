...
**Design**: Making things work well for people
**Art**: Expressing what things mean
...
**Utility**: What we can do with it
**Behavior**: How we use it
**Knowledge**: What we learn from using it
